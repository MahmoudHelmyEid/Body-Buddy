            ...
            child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "One of the most important sources of sodium in food is sodium chloride, which is a salty taste that the body needs in very small quantities to balance the fluid level in the body. Chloride helps in the process of digesting food.",
                  ...
                  DataTable(columns: [
                    ...
                    DataColumn(label: Text("(Grams/day)")),
                  ], rows: [
                    DataRow(cells: [
                      DataCell(Text("Men")),
                      DataCell(Text("5")),
