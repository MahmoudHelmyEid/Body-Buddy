...
class BenefitsB9 extends StatelessWidget {
  const BenefitsB9({super.key});
            ...
            child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Vitamin B9 is one of the water-soluble vitamins. Vitamin B9 is needed to contribute to the production of DNA, RNA, and other genetic materials. It is involved in the metabolism of amino acids, and the human body also needs it for healthy cell division.",
