...
import 'package:untitled/vitamins/vitamin%20B9/benefitsB9.dart';
import 'package:untitled/vitamins/vitamin%20B9/foodsB9.dart';
import 'package:untitled/vitamins/vitamin%20B9/sideEffectsB9.dart';

class vitaminB9 extends StatefulWidget {
  const vitaminB9({super.key});

  @override
  State<vitaminB9> createState() => _vitaminAState();
}

class _vitaminAState extends State<vitaminB9> {
  @override
