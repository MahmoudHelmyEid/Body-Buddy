...
import 'package:untitled/vitamins/vitamin%20C/benefitsC.dart';
import 'package:untitled/vitamins/vitamin%20C/foodsC.dart';
import 'package:untitled/vitamins/vitamin%20C/sideEffecetsC.dart';

class vitaminC extends StatefulWidget {
  const vitaminC({super.key});

  @override
  State<vitaminC> createState() => _vitaminAState();
}

class _vitaminAState extends State<vitaminC> {
  @override
