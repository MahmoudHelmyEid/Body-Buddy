...
import 'package:untitled/vitamins/vitamin%20D/benefitsD.dart';
import 'package:untitled/vitamins/vitamin%20D/foodsD.dart';
import 'package:untitled/vitamins/vitamin%20D/sideEffecetsD.dart';

class vitaminD extends StatefulWidget {
  const vitaminD({super.key});

  @override
  State<vitaminD> createState() => _vitaminAState();
}

class _vitaminAState extends State<vitaminD> {
  @override
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            bottom: TabBar(
                ...
                labelColor: Color.fromARGB(255, 251, 251, 251),
